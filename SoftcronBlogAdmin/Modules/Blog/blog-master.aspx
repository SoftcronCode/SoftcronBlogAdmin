                ...
                <div class="block">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label for="blog-title">Meta Keyword <span class="text-danger">*</span></label>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <asp:LinkButton ID="btnDelete" runat="server" CommandName="delete" CommandArgument='<%# Eval("blog_master_id")%>' class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="bottom" title="Click to edit" data-original-title="Basic tooltp"><i class="fa fa-times"></i></asp:LinkButton>
