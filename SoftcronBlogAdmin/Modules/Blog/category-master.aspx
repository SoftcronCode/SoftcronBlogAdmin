...
<asp:Content ID="Content2" ContentPlaceHolderID="pagecontent" runat="server">
    ...
    <div id="page-content">
        ...
        <%-- Active/Deactive Status Modal Start--%>
        ...
        <%-- Active/Deactive Status Modal End--%>

        <%--Delete Modal Start--%>
        <div id="modal-content2">
            <div id="modal-delete-blog" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header text-center">
                        ...
                        <!-- END Modal Header -->
                        <asp:HiddenField ID="hdnfDeleteBlogCategory" runat="server" />
                        <!-- Modal Body -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="block">
                                            ...
                                            <div class="block-title">
                                                ...
                                                <h2><strong>Delete</strong> Blog-Category </h2>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <h5>
                                                            <label for="example-nf-email" class="text-danger ">Are you sure want to Delete Blog-Category ?</label>
                                                        </h5>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-actions text-right">
                                                        <%--<button type="submit" class="btn btn-sm btn-primary"> Yes </button>--%>
                                                        <asp:LinkButton ID="dltYesBtn" runat="server" OnClick="dltYesBtn_Click" CssClass="btn btn-primary form-actions"> Yes </asp:LinkButton>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">No </button>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <asp:LinkButton ID="btnDelete" runat="server" CommandName="delete" CommandArgument='<%# Eval("blog_category_id")%>' class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="bottom" title="Click to Delete" data-original-title="Basic tooltp"><i class="fa fa-times"></i></asp:LinkButton>
